  ...
  data() {
    return {
      ...
      sponsors: [
        {
          name: "sponsor-1",
          img: "/clients_partner_1-200x202.png",
        },
        {
          name: "sponsor-2",
          img: "/clients_partner_2-200x202.png",
        },
        {
          name: "sponsor-3",
          img: "/clients_partner_3-200x202.png",
        },
        {
          name: "sponsor-4",
          img: "/clients_partner_4-200x202.png",
        },
      ],
    };
  },
  ...
  <div class="container">
    ...
    <div id="slider">
      ...
      <div class="slide_text">
        <div class="review">{{ slides[active].review }}</div>
        <div>
          <span class="name">{{ slides[active].name }}</span>
          <span>, {{ slides[active].agency }}</span>
        </div>
      </div>
